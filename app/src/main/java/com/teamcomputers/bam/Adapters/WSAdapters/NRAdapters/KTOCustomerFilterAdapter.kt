...
class KTOCustomerFilterAdapter(val dashboardActivityContext: DashboardActivity, val data: List<KNRCustomerModel.Datum>) : RecyclerView.Adapter<KTOCustomerFilterAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun showData(filterData: KNRCustomerModel.Datum, position: Int) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): KTOCustomerFilterAdapter.ViewHolder {
