...
public class SalesPersonAdapter extends RecyclerView.Adapter<SalesPersonAdapter.ViewHolder> {
    ...
    public SalesPersonAdapter(DashboardActivity dashboardActivityContext, String type, List<FullSalesModel> data) {
        this.dataList = data;
        this.type = type;
    ...
    @Override
    public SalesPersonAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(SalesPersonAdapter.ViewHolder holder, final int position) {
        if (position == 0) {
