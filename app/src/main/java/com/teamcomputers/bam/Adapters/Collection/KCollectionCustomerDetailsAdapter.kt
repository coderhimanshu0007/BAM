...
class KCollectionCustomerDetailsAdapter(val mContext: DashboardActivity, val dataList: List<CollectionCollectionDetailModel.Datum>) : RecyclerView.Adapter<KCollectionCustomerDetailsAdapter.ViewHolder>() {

    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        init {
        }

        fun setData(mContext: Context, dataList: CollectionCollectionDetailModel.Datum?) {
