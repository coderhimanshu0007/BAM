...
class KSalesRSMFilterAdapter(val dashboardActivityContext: DashboardActivity, val data: List<KSalesRSMModel.Data>) : RecyclerView.Adapter<KSalesRSMFilterAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun showData(filterData: KSalesRSMModel.Data, position: Int) {
