...
class KPSOCustomerFilterAdapter(val dashboardActivityContext: DashboardActivity, val data: List<KPSOCustomerModel.Datum>) : RecyclerView.Adapter<KPSOCustomerFilterAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun showData(filterData: KPSOCustomerModel.Datum, position: Int) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): KPSOCustomerFilterAdapter.ViewHolder {
