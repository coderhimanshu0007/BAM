...
public class RSMAdapter extends RecyclerView.Adapter<RSMAdapter.ViewHolder> {
    ...
    @Override
    public RSMAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(RSMAdapter.ViewHolder holder, final int position) {
        if (position == 0) {
