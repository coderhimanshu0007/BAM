...
class KTORSMFilterAdapter(val dashboardActivityContext: DashboardActivity, val data: List<KNRRSMModel.Datum>) : RecyclerView.Adapter<KTORSMFilterAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun showData(filterData: KNRRSMModel.Datum, position: Int) {
