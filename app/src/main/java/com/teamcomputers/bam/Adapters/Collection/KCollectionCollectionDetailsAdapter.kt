...
class KCollectionCollectionDetailsAdapter(val mContext: DashboardActivity, val dataList: List<CollectionCollectionDetailModel.Datum>) : RecyclerView.Adapter<KCollectionCollectionDetailsAdapter.ViewHolder>() {

    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        var currentDataItem: CollectionCollectionDetailModel.Datum? = null
        ...
        fun setData(mContext: Context, dataList: CollectionCollectionDetailModel.Datum?, pos: Int) {
