...
public interface BAMConstant {
    ...
    interface Events {
        ...
        int GET_COLLECTION_OUTSTANDING_CUSTOMER_SUCCESSFULL = 731;
        int GET_COLLECTION_OUTSTANDING_CUSTOMER_UNSUCCESSFULL = 732;
        int GET_TOTAL_OUTSTANDING_INVOICE_SUCCESSFULL = 733;
        int GET_TOTAL_OUTSTANDING_INVOICE_UNSUCCESSFULL = 734;
        int GET_TOTAL_OUTSTANDING_INVOICE_LOAD_MORE_SUCCESSFULL = 735;
        int GET_TOTAL_OUTSTANDING_INVOICE_LOAD_MORE_UNSUCCESSFULL = 736;
        int GET_TOTAL_OUTSTANDING_INVOICE_SEARCH_SUCCESSFULL = 737;
        int GET_TOTAL_OUTSTANDING_INVOICE_SEARCH_UNSUCCESSFULL = 738;

        int GET_COLLECTION_OS_AGEING_SUCCESSFULL = 76;
        int GET_COLLECTION_OS_AGEING_UNSUCCESSFULL = 77;

        int GET_COLLECTION_WIP_SUCCESSFULL = 78;
        int GET_COLLECTION_WIP_UNSUCCESSFULL = 79;
        int GET_COLLECTION_WIP_CUSTOMER_SUCCESSFULL = 791;
        int GET_COLLECTION_WIP_CUSTOMER_UNSUCCESSFULL = 792;
        int GET_COLLECTION_WIP_CUSTOMER_INVOICE_SUCCESSFULL = 793;
        int GET_COLLECTION_WIP_CUSTOMER_INVOICE_UNSUCCESSFULL = 794;
        int GET_COLLECTION_WIP_CUSTOMER_INVOICE_LOAD_MORE_SUCCESSFULL = 795;
        int GET_COLLECTION_WIP_CUSTOMER_INVOICE_LOAD_MORE_UNSUCCESSFULL = 796;
        int GET_COLLECTION_WIP_CUSTOMER_INVOICE_SEARCH_SUCCESSFULL = 797;
        int GET_COLLECTION_WIP_CUSTOMER_INVOICE_SEARCH_UNSUCCESSFULL = 798;

        int GET_COLLECTION_COLLECTION_SUCCESSFULL = 74;
        int GET_COLLECTION_COLLECTION_UNSUCCESSFULL = 75;
        int GET_COLLECTION_COLLECTION_CUSTOMER_SUCCESSFULL = 751;
        int GET_COLLECTION_COLLECTION_CUSTOMER_UNSUCCESSFULL = 752;
        int GET_COLLECTION_COLLECTION_CUSTOMER_INVOICE_SUCCESSFULL = 753;
        int GET_COLLECTION_COLLECTION_CUSTOMER_INVOICE_UNSUCCESSFULL = 754;
        int GET_COLLECTION_COLLECTION_CUSTOMER_INVOICE_LOAD_MORE_SUCCESSFULL = 755;
        int GET_COLLECTION_COLLECTION_CUSTOMER_INVOICE_LOAD_MORE_UNSUCCESSFULL = 756;
        int GET_COLLECTION_COLLECTION_CUSTOMER_INVOICE_SEARCH_SUCCESSFULL = 757;
        int GET_COLLECTION_COLLECTION_CUSTOMER_INVOICE_SEARCH_UNSUCCESSFULL = 758;
        ...
        int GET_RSM_LIST_SUCCESSFULL = 110;
        int GET_RSM_LIST_UNSUCCESSFULL = 111;
        int GET_SALES_LIST_SUCCESSFULL = 112;
        int GET_SALES_LIST_UNSUCCESSFULL = 113;
        int GET_CUSTOMER_LIST_SUCCESSFULL = 114;
        int GET_CUSTOMER_LIST_UNSUCCESSFULL = 115;
        int GET_PRODUCT_LIST_SUCCESSFULL = 116;
        int GET_PRODUCT_LIST_UNSUCCESSFULL = 117;

        int GET_RSM_OSO_LIST_SUCCESSFULL = 118;
        int GET_RSM_OSO_LIST_UNSUCCESSFULL = 119;
        int GET_SALES_OSO_LIST_SUCCESSFULL = 120;
        int GET_SALES_OSO_LIST_UNSUCCESSFULL = 121;
        int GET_CUSTOMER_OSO_LIST_SUCCESSFULL = 122;
        int GET_CUSTOMER_OSO_LIST_UNSUCCESSFULL = 123;
        int GET_INVOICE_OSO_LIST_SUCCESSFULL = 124;
        int GET_INVOICE_OSO_LIST_UNSUCCESSFULL = 125;
        int GET_PRODUCT_OSO_LIST_SUCCESSFULL = 126;
        int GET_PRODUCT_OSO_LIST_UNSUCCESSFULL = 127;

        int GET_RSM_TOS_LIST_SUCCESSFULL = 128;
        int GET_RSM_TOS_LIST_UNSUCCESSFULL = 129;
        int GET_SALES_TOS_LIST_SUCCESSFULL = 130;
        int GET_SALES_TOS_LIST_UNSUCCESSFULL = 131;
        int GET_CUSTOMER_TOS_LIST_SUCCESSFULL = 132;
        int GET_CUSTOMER_TOS_LIST_UNSUCCESSFULL = 133;
        int GET_PRODUCT_TOS_LIST_SUCCESSFULL = 134;
        int GET_PRODUCT_TOS_LIST_UNSUCCESSFULL = 135;
        int GET_INVOICE_TOS_LIST_SUCCESSFULL = 136;
        int GET_INVOICE_TOS_LIST_UNSUCCESSFULL = 137;

        int GET_FISCAL_YEAR_LIST_SUCCESSFULL = 138;
        int GET_FISCAL_YEAR_LIST_UNSUCCESSFULL = 139;
        int GET_SALES_RECEIVABLE_FISCAL_SUCCESSFULL = 140;
        int GET_SALES_RECEIVABLE_FISCAL_UNSUCCESSFULL = 141;

        int GET_INVOICE_LOAD_MORE_SUCCESSFULL = 142;
        int GET_INVOICE_LOAD_MORE_UNSUCCESSFULL = 143;
        ...
        int GET_INSIGHTS_SEARCH_SUCCESSFULL = 156;
        int GET_INSIGHTS_SEARCH_UNSUCCESSFULL = 157;

        int GET_CTOS_SEARCH_SUCCESSFULL = 158;
        int GET_CTOS_SEARCH_UNSUCCESSFULL = 159;

        int GET_WIP_DETAIL_LOAD_MORE_SUCCESSFULL = 160;
        int GET_WIP_DETAIL_LOAD_MORE_UNSUCCESSFULL = 161;

        int GET_WIP_DETAIL_SEARCH_SUCCESSFULL = 162;
        int GET_WIP_DETAIL_SEARCH_UNSUCCESSFULL = 163;
    }
    ...
    interface Fragments {
        ...
        int OSO_PRODUCT_FRAGMENT = 1009;

        int TOS_RSM_FRAGMENT = 1010;
        int TOS_ACCOUNT_FRAGMENT = 1011;
        int TOS_CUSTOMER_FRAGMENT = 1012;
        int TOS_PRODUCT_FRAGMENT = 1013;
        int TOS_INVOICE_FRAGMENT = 1014;

        int TOTAL_OUTSTANDING_FRAGMENT = 1015;
        ...
        int WIP_CUSTOMER_DETAIL_FRAGMENT = 1020;
    }
    ...
    interface ClickEvents {
        ...
        int SO_ITEM_SELECT = 213;

        int COLLECTION_CUSTOMER_SELECT = 214;
        int WIP_CUSTOMER_SELECT = 215;
        int WS_PRODUCT_SEARCH = 216;

        int OSO_RSM_SEARCH = 217;
        int OSO_SP_SEARCH = 218;
        int OSO_CUSTOMER_SEARCH = 219;
        int OSO_INVOICE_SEARCH = 220;

        int TOS_RSM_SEARCH = 221;
        int TOS_SP_SEARCH = 212;
        int TOS_CUSTOMER_SEARCH = 223;
        int TOS_PRODUCT_SEARCH = 224;
    }
