...
public interface BAMConstant {
    ...
    interface Events {
        ...
        int GET_COLLECTION_TOTAL_OUTSTANDING_SUCCESSFULL = 731;
        int GET_COLLECTION_TOTAL_OUTSTANDING_UNSUCCESSFULL = 732;
        ...
        int GET_COLLECTION_WIP_DETAIL_SUCCESSFULL = 791;
        int GET_COLLECTION_WIP_DETAIL_UNSUCCESSFULL = 792;
        int GET_COLLECTION_COLLECTION_DETAIL_SUCCESSFULL = 793;
        int GET_COLLECTION_COLLECTION_DETAIL_UNSUCCESSFULL = 794;
        int GET_COLLECTION_CUSTOMER_DETAIL_SUCCESSFULL = 795;
        int GET_COLLECTION_CUSTOMER_DETAIL_UNSUCCESSFULL = 796;
