...
public interface BAMConstant {
    ...
    interface Events {
        ...
        int GET_RSM_TOS_LIST_SUCCESSFULL = 126;
        int GET_RSM_TOS_LIST_UNSUCCESSFULL = 127;
        int GET_SALES_TOS_LIST_SUCCESSFULL = 128;
        int GET_SALES_TOS_LIST_UNSUCCESSFULL = 129;
        int GET_CUSTOMER_TOS_LIST_SUCCESSFULL = 130;
        int GET_CUSTOMER_TOS_LIST_UNSUCCESSFULL = 131;
        int GET_PRODUCT_TOS_LIST_SUCCESSFULL = 132;
        int GET_PRODUCT_TOS_LIST_UNSUCCESSFULL = 133;

        int GET_FISCAL_YEAR_LIST_SUCCESSFULL = 134;
        int GET_FISCAL_YEAR_LIST_UNSUCCESSFULL = 135;
        int GET_SALES_RECEIVABLE_FISCAL_SUCCESSFULL = 136;
        int GET_SALES_RECEIVABLE_FISCAL_UNSUCCESSFULL = 137;
    }
