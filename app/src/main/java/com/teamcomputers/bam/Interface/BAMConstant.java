...
public interface BAMConstant {
    ...
    interface Events {
        ...
        int GET_SALES_RECEIVABLE_REFRESH_SUCCESSFULL = 80;
        int GET_SALES_RECEIVABLE_REFRESH_UNSUCCESSFULL = 81;
        int GET_SALES_RECEIVABLE_SALES_SUCCESSFULL = 82;
        int GET_SALES_RECEIVABLE_SALES_UNSUCCESSFULL = 83;
        int GET_SALES_RECEIVABLE_OUTSTANDING_SUCCESSFULL = 84;
        int GET_SALES_RECEIVABLE_OUTSTANDING_UNSUCCESSFULL = 85;
    }
