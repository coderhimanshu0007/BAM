...
public interface KBAMConstant {
    ...
    interface Events {
        companion object {
            ...
            val GET_COLLECTION_TOTAL_OUTSTANDING_SUCCESSFULL = 731
            val GET_COLLECTION_TOTAL_OUTSTANDING_UNSUCCESSFULL = 732
            ...
            val GET_COLLECTION_WIP_DETAIL_SUCCESSFULL = 791
            val GET_COLLECTION_WIP_DETAIL_UNSUCCESSFULL = 792
            val GET_COLLECTION_COLLECTION_DETAIL_SUCCESSFULL = 793
            val GET_COLLECTION_COLLECTION_DETAIL_UNSUCCESSFULL = 794
            val GET_COLLECTION_CUSTOMER_DETAIL_SUCCESSFULL = 795
            val GET_COLLECTION_CUSTOMER_DETAIL_UNSUCCESSFULL = 796
