...
public interface KBAMConstant {
    ...
    interface Events {
        companion object {
            ...
            val GET_COLLECTION_OUTSTANDING_CUSTOMER_SUCCESSFULL = 731
            val GET_COLLECTION_OUTSTANDING_CUSTOMER_UNSUCCESSFULL = 732
            val GET_TOTAL_OUTSTANDING_INVOICE_SUCCESSFULL = 733
            val GET_TOTAL_OUTSTANDING_INVOICE_UNSUCCESSFULL = 734
            val GET_TOTAL_OUTSTANDING_INVOICE_LOAD_MORE_SUCCESSFULL = 735
            val GET_TOTAL_OUTSTANDING_INVOICE_LOAD_MORE_UNSUCCESSFULL = 736
            val GET_TOTAL_OUTSTANDING_INVOICE_SEARCH_SUCCESSFULL = 737
            val GET_TOTAL_OUTSTANDING_INVOICE_SEARCH_UNSUCCESSFULL = 738

            val GET_COLLECTION_OS_AGEING_SUCCESSFULL = 76
            val GET_COLLECTION_OS_AGEING_UNSUCCESSFULL = 77

            val GET_COLLECTION_WIP_SUCCESSFULL = 78
            val GET_COLLECTION_WIP_UNSUCCESSFULL = 79
            val GET_COLLECTION_WIP_CUSTOMER_SUCCESSFULL = 791
            val GET_COLLECTION_WIP_CUSTOMER_UNSUCCESSFULL = 792
            val GET_COLLECTION_WIP_CUSTOMER_INVOICE_SUCCESSFULL = 793
            val GET_COLLECTION_WIP_CUSTOMER_INVOICE_UNSUCCESSFULL = 794
            val GET_COLLECTION_WIP_CUSTOMER_INVOICE_LOAD_MORE_SUCCESSFULL = 795
            val GET_COLLECTION_WIP_CUSTOMER_INVOICE_LOAD_MORE_UNSUCCESSFULL = 796
            val GET_COLLECTION_WIP_CUSTOMER_INVOICE_SEARCH_SUCCESSFULL = 797
            val GET_COLLECTION_WIP_CUSTOMER_INVOICE_SEARCH_UNSUCCESSFULL = 798

            val GET_COLLECTION_COLLECTION_SUCCESSFULL = 74
            val GET_COLLECTION_COLLECTION_UNSUCCESSFULL = 75
            val GET_COLLECTION_COLLECTION_CUSTOMER_SUCCESSFULL = 751
            val GET_COLLECTION_COLLECTION_CUSTOMER_UNSUCCESSFULL = 752
            val GET_COLLECTION_COLLECTION_CUSTOMER_INVOICE_SUCCESSFULL = 753
            val GET_COLLECTION_COLLECTION_CUSTOMER_INVOICE_UNSUCCESSFULL = 754
            val GET_COLLECTION_COLLECTION_CUSTOMER_INVOICE_LOAD_MORE_SUCCESSFULL = 755
            val GET_COLLECTION_COLLECTION_CUSTOMER_INVOICE_LOAD_MORE_UNSUCCESSFULL = 756
            val GET_COLLECTION_COLLECTION_CUSTOMER_INVOICE_SEARCH_SUCCESSFULL = 757
            val GET_COLLECTION_COLLECTION_CUSTOMER_INVOICE_SEARCH_UNSUCCESSFULL = 758
            ...
            val GET_INSIGHTS_SEARCH_SUCCESSFULL = 156
            val GET_INSIGHTS_SEARCH_UNSUCCESSFULL = 157

            val GET_CTOS_SEARCH_SUCCESSFULL = 158
            val GET_CTOS_SEARCH_UNSUCCESSFULL = 159

            val GET_WIP_DETAIL_LOAD_MORE_SUCCESSFULL = 160
            val GET_WIP_DETAIL_LOAD_MORE_UNSUCCESSFULL = 161

            val GET_WIP_DETAIL_SEARCH_SUCCESSFULL = 162
            val GET_WIP_DETAIL_SEARCH_UNSUCCESSFULL = 163
        }
    }
