...
public interface KBAMConstant {
    ...
    interface Events {
        companion object {
            ...
            val GET_RSM_TOS_LIST_SUCCESSFULL = 126
            val GET_RSM_TOS_LIST_UNSUCCESSFULL = 127
            val GET_SALES_TOS_LIST_SUCCESSFULL = 128
            val GET_SALES_TOS_LIST_UNSUCCESSFULL = 129
            val GET_CUSTOMER_TOS_LIST_SUCCESSFULL = 130
            val GET_CUSTOMER_TOS_LIST_UNSUCCESSFULL = 131
            val GET_PRODUCT_TOS_LIST_SUCCESSFULL = 132
            val GET_PRODUCT_TOS_LIST_UNSUCCESSFULL = 133

            val GET_FISCAL_YEAR_LIST_SUCCESSFULL = 134
            val GET_FISCAL_YEAR_LIST_UNSUCCESSFULL = 135
            val GET_SALES_RECEIVABLE_FISCAL_SUCCESSFULL = 136
            val GET_SALES_RECEIVABLE_FISCAL_UNSUCCESSFULL = 137
        }
    }
