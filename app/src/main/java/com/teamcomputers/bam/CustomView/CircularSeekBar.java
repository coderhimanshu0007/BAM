...
public class CircularSeekBar extends View {
    ...
    private static final int DEFAULT_CIRCLE_COLOR = Color.argb(242,242,242,242);
    private static final int DEFAULT_CIRCLE_PROGRESS_COLOR = Color.argb(235, 74, 138, 255);
    //private static final int DEFAULT_CIRCLE_PROGRESS_COLOR = Color.argb(235, 255, 0, 0);
...
//            }
    ...
    public void setCircleProgressColorRed() {
        mCircleProgressColor = Color.argb(235, 255, 0, 0);
        mCircleProgressPaint.setColor(mCircleProgressColor);
        invalidate();
    }

    public void setCircleProgressColorGreen() {
        mCircleProgressColor = Color.argb(235, 42, 255, 0);
        mCircleProgressPaint.setColor(mCircleProgressColor);
        invalidate();
    }
