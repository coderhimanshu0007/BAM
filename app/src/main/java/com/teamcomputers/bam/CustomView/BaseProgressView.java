...
import com.teamcomputers.bam.Interface.OnProgressTrackListener;
...
public abstract class BaseProgressView extends View {
    ...
    protected void initBackgroundColor() {
        ...
        if (isShadowed) {
            backgroundPaint.setShadowLayer(3.0f, 1.0f, 2.0f, shadowColor);
        }
    }
    ...
    protected void initForegroundColor() {
        ...
        if (isShadowed) {
            foregroundPaint.setShadowLayer(3.0f, 1.0f, 2.0f, shadowColor);
        }
    }
