...
public class NewProductR2Fragment extends BaseFragment {
...
*/
        ...
        BackgroundExecutor.getInstance().execute(new FullProductListRequester(userId, "R2", "Product", "", ""));
    ...
    public String getFragmentName() {
        return NewProductR2Fragment.class.getSimpleName();
    }
            ...
            public void run() {
                switch (eventObject.getId()) {
                    ...
                    case Events.GET_SELECTED_PRODUCT_LIST_SUCCESSFULL:
                        ...
                        SalesCustomerModel salesCustomerModel = ((NewSalesPersonTabFragment) getParentFragment()).customerList;
