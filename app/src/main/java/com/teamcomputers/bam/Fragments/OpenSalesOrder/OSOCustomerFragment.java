...
public class OSOCustomerFragment extends BaseFragment {
    ...
    boolean fromRSM, fromSP, fromInvoice;
    String toolbarTitle = "";
    String userId = "", level = "";
    ...
    private void row2Display() {
        ...
        if (rsmPos == 2) {
            ...
            tviR2SOAmount.setText(BAMUtil.getRoundOffValue(salesProfile.getSOAmount()));
        } else if (iPos == 2) {
            position = invoiceProfile.getPosition();
            if (position == 0) {
                llSPLayout.setBackgroundColor(getResources().getColor(R.color.color_first_item_value));
    ...
    private void row3Display() {
        if (rsmPos == 4) {
            ...
            tviR3SOAmount.setText(BAMUtil.getRoundOffValue(salesProfile.getSOAmount()));
        } else if (iPos == 4) {
            position = invoiceProfile.getPosition();
            if (position == 0) {
                llSPLayout.setBackgroundColor(getResources().getColor(R.color.color_first_item_value));
