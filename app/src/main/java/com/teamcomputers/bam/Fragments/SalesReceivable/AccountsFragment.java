...
public class AccountsFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        rsmDataModelArrayList.add(new RSMDataModel("Sagar Pushkarna", "625.2", "625.2", "625.2"));
        rsmDataModelArrayList.add(new RSMDataModel("Sagar Pushkarna", "625.2", "625.2", "625.2"));
        adapter = new AccountAdapter(dashboardActivityContext, rsmDataModelArrayList);
            ...
            public void run() {
                switch (eventObject.getId()) {
                    ...
                    case ClickEvents.ACCOUNT_ITEM:
                        ...
                        acctDataBundle.putParcelable(AccountsFragment.USER_PROFILE, (RSMDataModel) eventObject.getObject());
