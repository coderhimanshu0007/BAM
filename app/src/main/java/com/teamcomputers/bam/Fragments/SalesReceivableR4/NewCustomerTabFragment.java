...
public class NewCustomerTabFragment extends BaseFragment {
    ...
    public String getFragmentName() {
        return NewCustomerTabFragment.class.getSimpleName();
    }
                ...
                switch (eventObject.getId()) {
                    ...
                    case ClickEvents.CUSTOMER_SELECT:
                        ...
                        if (id.equals(userId)) {
                            ...
                            BackgroundExecutor.getInstance().execute(new SelectedProductListRequester(userId, "R4", "Product", customerList.getCustomerName(), ""));
                        } else {
                            BackgroundExecutor.getInstance().execute(new SelectedProductListRequester(id, "R4", "Product", customerList.getCustomerName(), ""));
                        }
                        tabLayout.getTabAt(1).select();
                    ...
                    case ClickEvents.STATE_SELECT:
                        ...
                        if (id.equals(userId)) {
                            ...
                            BackgroundExecutor.getInstance().execute(new SelectedProductListRequester(userId, "R4", "Product", customerList.getCustomerName(), customerList.getStateCodeWise().get(0).getStateCode()));
                        } else {
                            BackgroundExecutor.getInstance().execute(new SelectedProductListRequester(id, "R4", "Product", customerList.getCustomerName(), customerList.getStateCodeWise().get(0).getStateCode()));
                        }
                        tabLayout.getTabAt(1).select();
                        break;
                    case BackpressEvents.R4_BACK_PRESS:
    ...
    public class TabsAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    NewCustomerR4Fragment newCustomerFragment = new NewCustomerR4Fragment();
                    newCustomerFragment.setArguments(bundle);
                    return newCustomerFragment;
                case 1:
                    NewProductR4Fragment newProductFragment = new NewProductR4Fragment();
