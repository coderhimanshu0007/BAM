...
public class ProductFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        rsmDataModelArrayList.add(new RSMDataModel("Product_1", "625.2", "",""));
        rsmDataModelArrayList.add(new RSMDataModel("Product_2", "625.2", "",""));
        rsmDataModelArrayList.add(new RSMDataModel("Product_3", "625.2", "",""));
        rsmDataModelArrayList.add(new RSMDataModel("Product_4", "625.2", "",""));
        rsmDataModelArrayList.add(new RSMDataModel("Product_5", "625.2", "",""));
        rsmDataModelArrayList.add(new RSMDataModel("Product_6", "625.2", "",""));
        rsmDataModelArrayList.add(new RSMDataModel("Product_7", "625.2", "",""));
        rsmDataModelArrayList.add(new RSMDataModel("Product_8", "625.2", "",""));
        rsmDataModelArrayList.add(new RSMDataModel("Product_9", "625.2", "",""));
        rsmDataModelArrayList.add(new RSMDataModel("Product_10", "625.2", "",""));
        adapter = new ProductAdapter(dashboardActivityContext, rsmDataModelArrayList);
