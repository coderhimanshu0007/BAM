...
public class NewProductR4Fragment extends BaseFragment {
...
*/
    ...
    public String getFragmentName() {
        return NewProductR4Fragment.class.getSimpleName();
    }
            ...
            public void run() {
                switch (eventObject.getId()) {
                    ...
                    case Events.GET_SELECTED_PRODUCT_LIST_SUCCESSFULL:
                        ...
                        SalesCustomerModel salesCustomerModel = ((NewCustomerTabFragment) getParentFragment()).customerList;
