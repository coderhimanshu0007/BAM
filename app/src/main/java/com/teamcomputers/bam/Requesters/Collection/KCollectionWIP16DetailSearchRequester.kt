...
class KCollectionWIP16DetailSearchRequester(var customer: String, var invoice: String) : BaseRequester {
    override fun run() {
        val apiResponse = KHTTPOperationController().collectionWIP16Search(customer, invoice)
        if (apiResponse != null) {
