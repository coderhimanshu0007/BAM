...
public class FullProductListRequester implements BaseRequester {
    String userId;
    String level;
    String type;
    String customer;
    ...
    public FullProductListRequester(String userId, String level, String type, String customer, String stateCode) {
        this.userId = userId;
        this.level = level;
        this.type = type;
        ...
        if (apiResponse != null) {
            if (apiResponse.getResponseCode() == HttpURLConnection.HTTP_OK) {
                ...
                if (apiResponse.getResponse() != null) {
                    EventBus.getDefault().post(new EventObject(Events.GET_FULL_PRODUCT_LIST_SUCCESSFULL, apiResponse.getResponse()));
                } else {
                    EventBus.getDefault().post(new EventObject(Events.GET_FULL_PRODUCT_LIST_UNSUCCESSFULL, null));
                }
