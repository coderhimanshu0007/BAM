...
class KCollectionWIP0DetailRequester(var start: String, var end: String, var more: Int) : BaseRequester {
    override fun run() {
        val apiResponse = KHTTPOperationController().collectionWIP0(start, end)
        if (apiResponse != null) {
